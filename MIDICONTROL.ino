...
//Button setup calls
Button BUTTON1(6, &BUTTON1_PRESS, &BUTTON1_RELEASE, &BUTTON1_HOLD);
Button BUTTON2(4, &BUTTON2_PRESS, &BUTTON2_RELEASE, &BUTTON2_HOLD);
Button BUTTON3(2, &BUTTON3_PRESS, &BUTTON3_RELEASE, &BUTTON3_HOLD);
Button BUTTON4(7, &BUTTON4_PRESS, &BUTTON4_RELEASE, &BUTTON4_HOLD);
Button BUTTON5(5, &BUTTON5_PRESS, &BUTTON5_RELEASE, &BUTTON5_HOLD);
Button BUTTON6(3, &BUTTON6_PRESS, &BUTTON6_RELEASE, &BUTTON6_HOLD);
